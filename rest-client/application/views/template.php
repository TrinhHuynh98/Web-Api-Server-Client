                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li><a href="<?php echo site_url('Blog') ?>"><i class="glyphicon glyphicon-pencil"></i>Blog</a></li>
                            <li><a href="<?php echo site_url('products/list') ?>"><i class="glyphicon glyphicon-tasks"></i>Product</a></li>
